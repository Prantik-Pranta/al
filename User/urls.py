...
urlpatterns = [
    ...
    path('api/license-certificate/<int:lc_id>/', views.get_license_certificate, name='get_license_certificate'),
    path('edit_license_certificate', views.edit_license_certificate, name='edit_license_certificate'),
    path('api/skill-context-data/', views.get_skill_context_data, name='get_skill_context_data'),
    path('add_skill', views.add_skill, name='add_skill'),
    path('api/skill/<int:skill_id>/', views.get_skill_details, name='get_skill_details'),
